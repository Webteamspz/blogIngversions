...
// Ensure data import path points to your Next.js data folder (e.g., app/Data/blogData.js)
// I'm assuming you have your footer data in the same place as your header
import { blogData as data } from "../../Data/blogData"; 
import styles from "./Footer.module.css";

// Note: If html-react-parser is not installed, you'll need to run:
// npm install html-react-parser
import parse from "html-react-parser";

const Footer = () => {
  // If your data structure is different, adjust this `f` variable
  const f = data.footer;
      ...
      <div className="container">
        ...
        <div className={`${styles.footerTop}`}>
          <Link href="/" className={styles.footerLeft}>
            {/* If f.logo is coming from public folder (e.g., /logos/main-logo.png), it will work perfectly */}
            <img
              src={f.logo}
              alt={`${f.company} logo`}
          ...
          <nav className={styles.footNav}>
            {f.links.map((l: any, i: number) => {
              ...
              const isExternal = l.href.startsWith("http") || l.href.startsWith("mailto:") || l.href.startsWith("tel:");
