export const blogData = {
  ...
  posts: [
    {
      id: "post-46",
      title: "Designing Product Pages That Sell",
      slug: "designing-product-pages-that-sell",
      excerpt: "A design-led breakdown of the product page: hierarchy, imagery, the buy box, proof, and the details that quietly decide the sale.",
    ...
    {
      id: "post-45",
      title: "Building a Pre-Launch QA Process That Scales",
      slug: "prelaunch-qa-process-that-scales",
      excerpt: "Turn ad-hoc launch-day panic into a repeatable QA process: environments, a tiered checklist, automation, and a go/no-go gate.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "August 31, 2026",
    ...
    {
      id: "post-44",
      title: "Reading A/B Test Results Without Fooling Yourself",
      slug: "reading-ab-test-results-without-fooling-yourself",
      excerpt: "The statistical traps that make losing tests look like winners, and a simple discipline for calling results you can trust.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "August 30, 2026",
      readTime: "7 min read",
    ...
    {
      id: "post-43",
      title: "The Checkout Friction Audit: Find What Is Costing You Sales",
      slug: "checkout-friction-audit-cro",
      excerpt: "A structured way to walk your own checkout, score every point of friction, and prioritise the fixes that recover the most revenue.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "August 29, 2026",
      readTime: "8 min read",
      category: "CRO",
    ...
    {
      id: "post-42",
      title: "Speeding Up Your Shopify Store: A Practical Checklist",
      slug: "shopify-store-speed-optimization-checklist",
      excerpt: "A field-tested checklist for improving Shopify load times, from image handling and app audits to theme code and Core Web Vitals.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "August 28, 2026",
      readTime: "9 min read",
    ...
    {
      id: "post-41",
      title: "The Complete Guide to AI Reporting Workflows with Claude + MCP",
      slug: "ai-reporting-workflow-claude-mcp-guide",
      excerpt: "Automate data collection, analysis, and reporting with Claude AI and the Model Context Protocol (MCP) in a secure, scalable architecture.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "August 27, 2026",
      readTime: "12 min read",
      category: "AI & Automation",
      coverImage: "/assets/blog/covers/photo-1653564142033-ab3532091515.jpg",
    },
    {
      id: "post-1",
    ...
    },
    {
      ...
      slug: "shopify-apps-safe-to-uninstall",
      excerpt: "Every installed app adds a script. Here's how to audit your app stack and safely remove the ones quietly slowing your store down.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "June 2, 2026",
      readTime: "6 min read",
      category: "Shopify Development",
    ...
    },
    {
      ...
      slug: "shopify-bundles-boost-aov",
      excerpt: "A practical guide to setting up product bundles that lift average order value without confusing your checkout flow.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "June 6, 2026",
      readTime: "7 min read",
      category: "Shopify Development",
    ...
    },
    {
      ...
      slug: "shopify-technical-seo-checklist",
      excerpt: "Beyond good product descriptions, these are the technical fixes, from crawlability to structured data, that actually move rankings.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "June 10, 2026",
      readTime: "6 min read",
      category: "Shopify Development",
    ...
    },
    {
      ...
      slug: "exit-popups-that-convert",
      excerpt: "The difference between an exit popup that recovers a sale and one that gets closed instantly is almost never the discount.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "June 14, 2026",
      readTime: "5 min read",
      category: "CRO",
    ...
    },
    {
      ...
      slug: "personalization-tactics-lift-conversions",
      excerpt: "Real personalization changes what a customer actually sees. Here's what moves the needle without feeling invasive.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "June 19, 2026",
      readTime: "6 min read",
      category: "CRO",
    ...
    },
    {
      ...
      slug: "one-page-vs-multi-page-checkout",
      excerpt: "There's no universal winner between one-page and multi-step checkout, only what fits your traffic, product, and device mix.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "June 23, 2026",
      readTime: "6 min read",
      category: "CRO",
    ...
    },
    {
      ...
      slug: "sample-ratio-mismatch-ab-testing",
      excerpt: "A confident-looking test result can still be invalid if your traffic split was never actually even. Here's how to catch it.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "June 27, 2026",
      readTime: "5 min read",
      category: "A/B Testing",
    ...
    },
    {
      ...
      slug: "how-long-to-run-ab-test",
      excerpt: "\"Wait for significance\" is the most misleading advice in A/B testing. Here's a framework for deciding duration before you launch.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "July 1, 2026",
      readTime: "6 min read",
      category: "A/B Testing",
    ...
    },
    {
      ...
      slug: "regression-testing-shopify-releases",
      excerpt: "When releases happen weekly, manually re-testing everything isn't realistic. Here's how to build a regression suite that scales.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "July 5, 2026",
      readTime: "7 min read",
      category: "Quality Assurance",
    ...
    },
    {
      ...
      slug: "accessibility-testing-wcag-ecommerce",
      excerpt: "Accessibility isn't just a compliance checkbox, it's customers who can't complete checkout if you get it wrong. Here's how to test for it.",
      author: { name: "Ingversions Team", avatar: "/assets/team/author-1.png" },
      date: "July 9, 2026",
      readTime: "7 min read",
      category: "Quality Assurance",
